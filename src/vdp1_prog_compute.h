...
#define NB_COARSE_RAST_X 1
#define NB_COARSE_RAST_Y 1
...
"int wn_PnPoly( ivec2 P, point V[4]){\n"
...
#endif
"int cn_PnPoly( ivec2 P, point V[4]){\n"
...
//"  if (wn_PnPoly(P, Quad) == 1) return 1u;\n"
